...
function hashBg(name: string): string {
  const palette = [
    "#5865f2", "#2d7d46", "#c27c0e", "#a84300",
    "#ad1457", "#6a1b9a", "#00838f", "#1565c0",
  ]
  let h = 0
...
export default function SpacesRail({ servers, activeServerId, onSelectServer, onServerCreated }: Props) {
  ...
  return (
    ...
    >
      ...
      {servers.length > 0 && (
        <div style={{ width: "32px", height: "1px", background: "#2e3240", margin: "2px 0", flexShrink: 0 }} />
      )}
      ...
      {showForm ? (
          ...
          {tab === "create" ? (
            <form onSubmit={handleCreate} style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              ...
              <div style={{ display: "flex", gap: "6px" }}>
                ...
                >
                  <Icon icon="lucide:check" style={{ fontSize: "13px" }} />
            ...
            <form onSubmit={handleJoin} style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              ...
              <div style={{ display: "flex", gap: "6px" }}>
                ...
                >
                  <Icon icon="lucide:log-in" style={{ fontSize: "13px" }} />
                  {busy ? "Joining…" : "Join"}
                </button>
                <button type="button" onClick={closeForm} style={cancelBtnStyle}>
                  <Icon icon="lucide:x" style={{ fontSize: "13px" }} />
        ...
        <div
          ...
          onMouseEnter={(e) => { e.currentTarget.style.borderRadius = "14px"; e.currentTarget.style.background = "#2a3040" }}
          onMouseLeave={(e) => { e.currentTarget.style.borderRadius = "50%"; e.currentTarget.style.background = "#1e2229" }}
        >
          <Icon icon="lucide:plus" style={{ fontSize: "20px" }} />
        </div>
      )}
    </div>
  )
